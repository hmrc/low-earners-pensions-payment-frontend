...
class AppConfig @Inject()(config: Configuration):
  ...
  val verifyStatus = s"$backendUrl/low-earners-pensions-payment/bars/verify/status"
  val updateStatus = s"$backendUrl/low-earners-pensions-payment/bars/verify/update"
