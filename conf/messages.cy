...
dashboard.paymentHistory.cancelledInset.start = Yn dilyn adolygiad o''ch hawl, rydym wedi canslo
dashboard.paymentHistory.cancelledInset.end = o''ch taliadau.
dashboard.paymentHistory.cancelledInset.result.single = O ganlyniad i hyn, ni fydd y taliad hwn yn cael ei wneud.
dashboard.paymentHistory.cancelledInset.result.multiple = O ganlyniad i hyn, ni fydd y taliadau hyn yn cael eu gwneud.
...
breakdown.single.past.underpayment.paid.title = Cyfrifiad o''ch taliad ychwanegol o {0} a dalwyd
breakdown.single.past.underpayment.paid.heading = Cyfrifiad o''ch taliad ychwanegol o {0} a dalwyd
...
breakdown.single.past.cancelled.p1 = Yn dilyn adolygiad o''ch hawl, rydym wedi canslo''r taliad hwn. O ganlyniad, ni wneir y taliad hwn.
breakdown.single.past.underpayment.cancelled.title = Cyfrifiad o''ch taliad ychwanegol o {0} a ganslwyd
breakdown.single.past.underpayment.cancelled.heading = Cyfrifiad o''ch taliad ychwanegol o {0} a ganslwyd
breakdown.single.past.underpayment.cancelled.p1 = Yn dilyn adolygiad o''ch hawl, rydym wedi canslo''r taliad hwn. O ganlyniad, ni wneir y taliad hwn.
