...
dashboard.table.headerRow.taxYear = Tax year
dashboard.table.headerRow.amount = Amount
dashboard.table.headerRow.availableUntil = Available until
dashboard.table.headerRow.dateAccepted = Date accepted
dashboard.table.headerRow.status = Status
dashboard.table.headerRow.action = Action
...
dashboard.table.taxYearDates = 6 April {0} to 5 April {1}
